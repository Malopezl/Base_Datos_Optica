...
<div class="venta-view">
    ...
    <p>
        ...
        <?= Html::a(Yii::t('app', 'Regresar'), ['cliente/view', 'id'=>$model->ID_Paciente], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            'buttons'=>[
             'view' => function ($url, $model) {
                $url = '/ventaaccesorios/viewcl?id='.$model->ID;
...
<p><li><label>Ordenes:</label>:</li> </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'buttons'=>[
             'view' => function ($url, $model) {
                $url = '/orden/viewcl?id='.$model->Orden;
                return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
                            'title' =>'Ver Orden'
                ]);
            },
